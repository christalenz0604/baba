...
export const CommonQuestions: Question[] = [
  {
    ...
    options: [
      { id: 'Common1-1', text: '我比較想在立法院上班就好，不太想去查訪。', points: 0, isCorrect: false },
      { id: 'Common1-2', text: '總召叫我去哪我就去哪，絕對服從！', points: 1450, isCorrect: true },
      { id: 'Common1-3', text: '謝謝總召，但我不想去，怕被選民誤會', points: 0, isCorrect: false },
    ],
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'Common3-1', text: '先冷靜協商啦，不然又要演全武行，暴力行為不好。', points: 4, isCorrect: false },
      { id: 'Common3-2', text: '找總召討論，大家帶枕頭去守夜兼打地鋪。', points: 604, isCorrect: false },
      { id: 'Common3-3', text: '他們敢進來，就把他們全部燒掉。', points: 1969, isCorrect: true },
    ],
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'Common4-1', text: '鎖門、封門是必要手段，排除異議，就能快速通過委員會！', points: 1949, isCorrect: true },
      { id: 'Common4-2', text: '應該會先緩緩吧！我們黨內都還不知道內容耶！', points: 0, isCorrect: false },
      { id: 'Common4-3', text: '不會吧！三分鐘是要討論什麼？', points: 0, isCorrect: false },
    ],
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'Common5-1', text: '提案內容怎麼邊表決邊修改，這樣我舉手通過的到底是哪個內容？', points: 0, isCorrect: false },
      { id: 'Common5-2', text: '沒關係，這不用動腦，只要記得跟著黨舉手表決就好！', points: 3838, isCorrect: true },
      { id: 'Common5-3', text: '不怕700多份提案，但為什麼衛福部被刪到剩一塊錢？', points: 0, isCorrect: false },
    ],
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'Common6-1', text: '我不能接受這種獨厚特定國家配偶的提案。', points: 0, isCorrect: false },
      { id: 'Common6-2', text: '原本六年太久了，要照顧我大中華民族，四年比較恰當。', points: 6666, isCorrect: true },
      { id: 'Common6-3', text: '相較其他外籍配偶，中國籍配偶還可以讓年滿70歲、未滿12歲直系親屬依親，沒必要再開綠燈了。', points: 0, isCorrect: false },
    ],
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'Common7-1', text: '跟著黨規劃的就對了，65歲以上的鐵票最多了，再加上來依親中配的長輩，一定要通過法案拉攏這群民眾！', points: 7777, isCorrect: true },
      { id: 'Common7-2', text: '利用資產配置就有機會高年收但所得稅率未達20%，這可能會造成世代對立啊！', points: 88, isCorrect: false },
      { id: 'Common7-3', text: '目前健保已經很吃緊了，真的有能力負擔這項免健保費的法案？', points: 0, isCorrect: false },
    ],
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'Common8-1', text: '要明文規定大陸地區人民有點奇怪誒？我覺得需要再仔細研究。', points: 0, isCorrect: false },
      { id: 'Common8-2', text: '開放自由貿易區有可能為中國洗產地，屆時美國對台灣半導體相關產業免關稅的優惠可能會被取消，我反對這項提案。', points: 0, isCorrect: false },
      { id: 'Common8-3', text: '玉珍姐提出的法案一定是在照顧金門的同胞，我要大力支持她，為她連署背書。', points: 2666, isCorrect: true },
    ],
    explanation: {
