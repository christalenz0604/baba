...
export const characters: Character[] = [
  ...
  },
  {
    ...
    name: '林德福',
    districts:'新北市第9選區',
    avatar: getImagePath('/images/character/linTeFu_pic_Pickup.png'),
  ...
  //徐巧芯HSUCHIAOHSIN_題目OK
  {
    ...
    name: '徐巧芯',
    districts:'臺北市第7選區',
    avatar: getImagePath('/images/character/HSUCHIAOHSIN_pic_Pickup.png'),
...
//賴士葆LaiShyhBao
  {
    ...
    name: '賴士葆',
    districts:'臺北市第8選區',
    avatar: getImagePath('/images/character/LaiShyhBao_pic_Pickup.png'),
...
//王鴻薇wanghungwei
  {
    ...
    name: '王鴻薇',
    districts:'臺北市第3選區',
    avatar: getImagePath('/images/character/wanghungwei_pic_Pickup.png'),
...
//李彥秀LEEYEHSIU
  {
    ...
    name: '李彥秀',
    districts:'臺北市第4選區',
    avatar: getImagePath('/images/character/LEEYEHSIU_pic_Pickup.png'),
...
//葉元之YEHYUANCHIH
  {
    ...
    name: '葉元之',
    districts:'新北市第7選區',
    avatar: getImagePath('/images/character/YEHYUANCHIH_pic_Pickup.png'),
...
//洪孟楷
  {
    ...
    name: '洪孟楷',
    districts:'新北市第1選區',
    avatar: getImagePath('/images/character/HungMongKai_pic_Pickup.png'),
...
//羅明才
  {
    ...
    name: '羅明才',
    districts:'新北市第11選區',
    avatar: getImagePath('/images/character/LoMingTsai_pic_Pickup.png'),
...
//廖先翔
  {
    ...
    name: '廖先翔',
    districts:'新北市第12選區',
    avatar: getImagePath('/images/character/LIAOHsienHsiang_pic_Pickup.png'),
...
//羅智強
  {
    ...
    name: '羅智強',
    districts:'臺北市第6選區',
    avatar: getImagePath('/images/character/LOCHIHCHIANG_pic_Pickup.png'),
