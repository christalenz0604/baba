        ...
        <div className="max-w-4xl mx-auto" >
          <motion.div
            ...
            <div className="relative flex flex-col items-center w-full justify-center">
              ...
              <img
                src={getResult() === "成功"
                  ? getImagePath("/images/results/objects/result_Board_phoneSize_Win.webp")
                  : getImagePath("/images/results/objects/result_Board_phoneSize_Fail.webp")}
                className="w-full max-w-[900px] h-auto object-contain transition-all duration-300 mt-2 sm:mt-4 xs:mt-2"
                alt="結果底圖"
              />

              {/* 四個角落裝飾圖 - 疊在上方 */}
              <img src={getImagePath("/images/corner_LT.webp")} className="pointer-events-none absolute top-8 left-2 w-10 h-10 z-30" alt="LT" />
              <img src={getImagePath("/images/corner_RT.webp")} className="pointer-events-none absolute top-8 right-2 w-10 h-10 z-30" alt="RT" />
              <img src={getImagePath("/images/corner_LB.webp")} className="pointer-events-none absolute bottom-2 left-2 w-10 h-10 z-30" alt="LB" />
              <img src={getImagePath("/images/corner_RB.webp")} className="pointer-events-none absolute bottom-2 right-2 w-10 h-10 z-30" alt="RB" />
      ...
      <div className={`fixed left-0 right-0 bottom-0 z-45  ${getResult() === "成功" ? "bg-[#fe3427]" : "bg-[#1f31fe]"}`}>
        <div className="flex w-full max-w-7xl mx-auto items-center justify-between px-4 sm:px-6 py-2">
          ...
          <div className="flex-shrink-0 w-[72px] h-[72px] flex items-center">
            <img src={getImagePath("/images/logo.webp")} className="w-full h-auto object-contain" />
          </div>
