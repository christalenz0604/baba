...
const ResultsScreen: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-contain ${getResult() === "成功" ? "bg-[url('/images/result_bg_Win.png')]" : "bg-[url('/images/result_bg_Fail.png')]"} bg-cover py-10 px-2`}>
          ...
          <div className="flex w-full max-w-4xl items-center">
            ...
            <div className="flex flex-col w-full px-2">
              <div className="flex items-center justify-start gap-0">
                <button className="w-24 h-10 result-bb-images"></button>
